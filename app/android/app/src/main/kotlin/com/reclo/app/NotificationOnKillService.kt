...
class NotificationOnKillService: Service() {
    ...
    override fun onTaskRemoved(rootIntent: Intent?) {
        try {
            ...
            val notificationBuilder = NotificationCompat.Builder(this, "com.reclo.app")
            ...
            val channel = NotificationChannel("com.reclo.app", name, importance).apply {
