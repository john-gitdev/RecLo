...
#
# Examples:
#   ./measure_cpu_android.sh -p com.reclo.app.dev -n 15 -d 2 -o /tmp/omi_cpu.csv
...
Options:
  -p  Android package name (default: env PACKAGE or com.reclo.app.dev)
